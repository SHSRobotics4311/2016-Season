...
public class Robot extends IterativeRobot {
    ...
    RobotMap.init();
        ...
        oi = new OI();
        frameFront = NIVision.imaqCreateImage(NIVision.ImageType.IMAGE_RGB, 0);
    ...
    public void teleopPeriodic() {
        ...
        NIVision.IMAQdxGrab(sessionFront,frameFront,1);
        CameraServer.getInstance().setImage(frameFront);
        if(armMoving == false){
        	speed = .75;
        ...
        RobotMap.robotDriveDrive.arcadeDrive(-((oi.joystick1.getY())*.75),-((oi.joystick1.getX()))*.5);
       }
