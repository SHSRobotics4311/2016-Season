...
public class Robot extends IterativeRobot {
    ...
    public static BallHandling ballWheels;
    public static CameraMount cameraMount;
    public static ArmPincers emergencyDrive;
    ...
    RobotMap.init();
        ...
        arm = new Arm();
        ballWheels = new BallHandling();
        cameraMount = new CameraMount();
        emergencyDrive = new ArmPincers();
    ...
    public void teleopPeriodic() {
        ...
        if(armMoving == false){
        	...
        	RobotMap.robotDriveDrive.arcadeDrive(-((oi.joystick1.getY())/2),-((oi.joystick1.getX())/2));
        }
